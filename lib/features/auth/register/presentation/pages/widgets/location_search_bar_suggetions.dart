...
class LocationSearchBarSuggestions extends StatefulWidget {
  const LocationSearchBarSuggestions({super.key, this.onSaved});

  final void Function(int?)? onSaved;

  @override
  State<LocationSearchBarSuggestions> createState() =>
      _LocationSearchBarSuggestionsState();
}

class _LocationSearchBarSuggestionsState
    extends State<LocationSearchBarSuggestions> {
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                suffixIcon: SizedBox(
                  ...
                  height: 20,
                  child: Center(
                    child: SvgPicture.asset(Assets.images.icon.switcherIcon),
                  ),
                ),
